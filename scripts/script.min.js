...
//            alert(target.target);
        ...
        if (target.loadAside) {//this means specific community is being loaded 
            if (response.error.code) {
                if (target.target !== "#aside-community-list") {
                    $("#pageTitle").html("Oops! No Community found.");
                    if (target.loadAside) {
                        $("#commTitle").html('N/A');
                        $("#commDesc").html('N/A');
                        $("#comType").html("N/A");
            ...
            if (target.target === "#aside-community-list") {
                $(target.target).html('Oops! Seems you do not belong to any Community; Join Communities of your interest to get even more on Gossout. <a href="communities">Start here!</a>');
